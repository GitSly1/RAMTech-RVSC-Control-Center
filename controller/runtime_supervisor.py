...
class RuntimeSupervisor:
    def __init__(self, configs: Optional[Iterable[WorkerConfig]] = None, repository_mappings: Optional[Mapping[str, str]] = None, qa_endpoint: str = DEFAULT_QA_ENDPOINT, worker_module: str = "controller.generic_worker_host", max_restarts: int = 3, health_timeout: float = 1.0, process_factory: Optional[Callable[..., Any]] = None, health_checker: Optional[Callable[[WorkerConfig], Any]] = None, port_checker: Optional[Callable[[int], bool]] = None, mission_store: Optional[Any] = None, mission_store_path: Optional[str] = None, execute_timeout: float = 2100.0, execute_requester: Optional[Callable[[WorkerConfig, Mapping[str, Any]], Any]] = None, clock: Optional[Callable[[], float]] = None, stall_threshold: float = 300.0, starvation_threshold: float = 0.0, max_recovery_attempts: int = 2, recovery_handler: Optional[Callable[[WorkerConfig, Any, int], Any]] = None, max_rework_attempts: int = 2, control_port: int = 8766) -> None:
